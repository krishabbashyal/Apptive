...
const SidebarProfileTab = () => {
  return (
    <div className="w-full h-24  flex justify-center cursor-pointer bg-background">
...
const SidebarTab = ({ label, icon: Icon, customStyle }: SidebarTabProps) => {
  return (
    <div className={`h-12 flex  items-center bg-background cursor-pointer border-l-4 border-background ${customStyle || ""}`}>
